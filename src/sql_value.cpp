...
namespace coda {
    namespace db {
        ...
        sql_value::sql_value(const char *value, std::string::size_type len) : value_(
                sql_string(value, std::min(len, strlen(value)))) {
        }

        sql_value::sql_value(const wchar_t *value, std::string::size_type len) : value_(
                sql_wstring(value, std::min(len, wcslen(value)))) {
        }
