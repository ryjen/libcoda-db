...
namespace coda {
  namespace db {
    ...
    class bindable {
       ...
       */
      template <typename T> bindable &bind_list(size_t index, const T &value) {
       ...
       * @return a reference to this instance
       */
      bindable &bind(const std::vector<sql_value> &values,
       ...
       * @return a reference to this instance
       */
      virtual bindable &bind(const std::string &name,
                             const sql_value &value) = 0;
