  ...
  namespace db {
    namespace mysql {
      ...
      class row : public row_impl {
         ...
         */
        row(const std::shared_ptr<mysql::session> &db,
            const std::shared_ptr<MYSQL_RES> &res, MYSQL_ROW row);
      ...
      class stmt_row : public row_impl {
         ...
         */
        stmt_row(const std::shared_ptr<mysql::session> &sess,
                 const std::shared_ptr<MYSQL_STMT> &stmt,
                 const std::shared_ptr<MYSQL_RES> &metadata,
