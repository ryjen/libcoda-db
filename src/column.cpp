...
namespace coda::db {
    ...
    std::shared_ptr<column_impl> column::impl() const { return impl_; }

    column::operator sql_number() const { return impl_->to_value(); }

    column::operator sql_time() const { return impl_->to_value(); }

    column::operator sql_string() const { return impl_->to_value(); }

    column::operator sql_wstring() const { return impl_->to_value(); }

    column::operator sql_blob() const { return impl_->to_value(); }

    column::operator bool() const { return impl_->to_value(); }

    column::operator char() const { return impl_->to_value(); }

    column::operator unsigned char() const { return impl_->to_value(); }

    column::operator wchar_t() const { return impl_->to_value(); }

    column::operator short() const { return impl_->to_value(); }

    column::operator unsigned short() const { return impl_->to_value(); }

    column::operator int() const { return impl_->to_value(); }

    column::operator unsigned int() const { return impl_->to_value(); }

    column::operator long() const { return impl_->to_value(); }

    column::operator unsigned long() const { return impl_->to_value(); }

    column::operator long long() const { return impl_->to_value(); }

    column::operator unsigned long long() const { return impl_->to_value(); }

    column::operator float() const { return impl_->to_value(); }

    column::operator double() const { return impl_->to_value(); }
