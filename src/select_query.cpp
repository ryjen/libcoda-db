...
namespace coda {
  namespace db {
    ...
    string select_query::from() const { return tableName_; }

    vector<string> select_query::columns() const { return columns_; }
    ...
    string select_query::limit() const { return limit_; }
    string select_query::group_by() const { return groupBy_; }
    string select_query::order_by() const { return orderBy_; }

    where_builder &select_query::where() { return where_; }
