...
namespace coda {
  namespace db {
    shared_ptr<schema>
    schema_factory::create(const std::shared_ptr<session> &session,
    ...
    schema_factory::schema_factory(const schema_factory &other)
        : schema_cache_(other.schema_cache_) {}
    ...
    schema_factory::schema_factory(schema_factory &&other)
    ...
    schema_factory::get(const std::shared_ptr<session> &session,
                        const string &tableName) {
